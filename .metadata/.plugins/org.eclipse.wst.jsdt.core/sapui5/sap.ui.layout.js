...
/**
 * Attaches event handler <code>fnFunction</code> to the 'breakpointChanged' event of this <code>sap.ui.layout.DynamicSideContent</code>.
 * 
...
/**
 * Destroys all the mainContent in the aggregation
 * named <code>mainContent</code>.
 * @returns {sap.ui.layout.DynamicSideContent} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
...
/**
 * Destroys all the sideContent in the aggregation
 * named <code>sideContent</code>.
 * @returns {sap.ui.layout.DynamicSideContent} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'breakpointChanged' event of this <code>sap.ui.layout.DynamicSideContent</code>.
 * 
...
/**
 * Checks for the provided <code>sap.ui.core.Control</code> in the aggregation named <code>mainContent</code>.
...
/**
 * Checks for the provided <code>sap.ui.core.Control</code> in the aggregation named <code>sideContent</code>.
 * and returns its index if found or -1 otherwise.
 * @param {sap.ui.core.Control}
...
/**
 * Inserts a mainContent into the aggregation named <code>mainContent</code>.
 * @param {sap.ui.core.Control}
...
/**
 * Inserts a sideContent into the aggregation named <code>sideContent</code>.
 * @param {sap.ui.core.Control}
...
/**
 * Removes all the controls in the aggregation named <code>mainContent</code>.
 * 
...
/**
 * Removes all the controls in the aggregation named <code>sideContent</code>.
 * 
 * Additionally, it unregisters them from the hosting UIArea.
 * @returns {sap.ui.core.Control[]} An array of the removed elements (might be empty)
 * @public
...
/**
 * Removes a mainContent from the aggregation named <code>mainContent</code>.
...
/**
 * Removes a sideContent from the aggregation named <code>sideContent</code>.
...
/**
 * Removes all the controls in the aggregation named <code>fixContent</code>.
 * 
 * Additionally, it unregisters them from the hosting UIArea.
 * @returns {sap.ui.core.Control[]} An array of the removed elements (might be empty)
 * @public
...
/**
 * Removes a fixContent from the aggregation named <code>fixContent</code>.
...
/**
 * Removes all the controls in the aggregation named <code>formContainers</code>.
 * 
 * Additionally, it unregisters them from the hosting UIArea.
...
/**
 * Removes a formContainer from the aggregation named <code>formContainers</code>.
...
/**
 * Removes all the controls in the aggregation named <code>formElements</code>.
 * 
 * Additionally, it unregisters them from the hosting UIArea.
...
/**
 * Removes a formElement from the aggregation named <code>formElements</code>.
...
/**
 * Removes all the controls in the aggregation named <code>fields</code>.
 * 
 * Additionally, it unregisters them from the hosting UIArea.
 * @returns {sap.ui.core.Control[]} An array of the removed elements (might be empty)
 * @public
...
/**
 * Removes a field from the aggregation named <code>fields</code>.
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'resize' event of this <code>sap.ui.layout.Splitter</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'resize' event of this <code>sap.ui.layout.Splitter</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Removes all the controls in the aggregation named <code>contentAreas</code>.
 * 
 * Additionally, it unregisters them from the hosting UIArea.
 * @returns {sap.ui.core.Control[]} An array of the removed elements (might be empty)
 * @public
...
/**
 * Removes a contentArea from the aggregation named <code>contentAreas</code>.
