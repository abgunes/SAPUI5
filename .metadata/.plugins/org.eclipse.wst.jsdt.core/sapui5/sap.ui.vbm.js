...
/**
 * Adds some region into the aggregation named <code>regions</code>.
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'regionClick' event of this <code>sap.ui.vbm.AnalyticMap</code>.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'regionContextMenu' event of this <code>sap.ui.vbm.AnalyticMap</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.AnalyticMap</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'regionDeselect' event of this <code>sap.ui.vbm.AnalyticMap</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.AnalyticMap</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'regionSelect' event of this <code>sap.ui.vbm.AnalyticMap</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.AnalyticMap</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'regionClick' event of this <code>sap.ui.vbm.AnalyticMap</code>.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'regionContextMenu' event of this <code>sap.ui.vbm.AnalyticMap</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'regionDeselect' event of this <code>sap.ui.vbm.AnalyticMap</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'regionSelect' event of this <code>sap.ui.vbm.AnalyticMap</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Removes all the controls in the aggregation named <code>regions</code>.
 * 
...
/**
 * Removes a region from the aggregation named <code>regions</code>.
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'edgeClick' event of this <code>sap.ui.vbm.Area</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'edgeContextMenu' event of this <code>sap.ui.vbm.Area</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.Area</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'edgeClick' event of this <code>sap.ui.vbm.Area</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'edgeContextMenu' event of this <code>sap.ui.vbm.Area</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
 ...
 * <li>Aggregations
 * <ul>
 * <li>{@link #getItems items} : sap.ui.vbm.Area[]</li>
 * </ul>
 * </li>
 * <li>Events
 * <ul>
 ...
 * 
 */
sap.ui.vbm.Areas.prototype.click = function(oControlEvent) {  };
 ...
 * 
 */
sap.ui.vbm.Areas.prototype.contextMenu = function(oControlEvent) {  };
 ...
 * 
 */
sap.ui.vbm.Areas.prototype.drop = function(oControlEvent) {  };
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'click' event of this <code>sap.ui.vbm.Areas</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'contextMenu' event of this <code>sap.ui.vbm.Areas</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.Areas</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'drop' event of this <code>sap.ui.vbm.Areas</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.Areas</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'edgeClick' event of this <code>sap.ui.vbm.Areas</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.Areas</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'edgeContextMenu' event of this <code>sap.ui.vbm.Areas</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.Areas</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'click' event of this <code>sap.ui.vbm.Areas</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'contextMenu' event of this <code>sap.ui.vbm.Areas</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'drop' event of this <code>sap.ui.vbm.Areas</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'edgeClick' event of this <code>sap.ui.vbm.Areas</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'edgeContextMenu' event of this <code>sap.ui.vbm.Areas</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
 ...
 * <li>Aggregations
 * <ul>
 * <li>{@link #getItems items} : sap.ui.vbm.Box[]</li>
 * </ul>
 * </li>
 * <li>Events
 * <ul>
 ...
 * 
 */
sap.ui.vbm.Boxes.prototype.click = function(oControlEvent) {  };
 ...
 * 
 */
sap.ui.vbm.Boxes.prototype.contextMenu = function(oControlEvent) {  };
 ...
 * 
 */
sap.ui.vbm.Boxes.prototype.drop = function(oControlEvent) {  };
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'click' event of this <code>sap.ui.vbm.Boxes</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.Boxes</code> itself.
 * 
 * The event is raised when there is a click action on a Box.
 * @param {object}
 *            [oData] An application-specific payload object that will be passed to the event handler along with the event object when firing the event.
 ...
 *            fnFunction The function to be called when the event occurs.
 * @param {object}
 *            [oListener] Context object to call the event handler with. Defaults to this <code>sap.ui.vbm.Boxes</code> itself.
 * @returns {sap.ui.vbm.Boxes} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'contextMenu' event of this <code>sap.ui.vbm.Boxes</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.Boxes</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'drop' event of this <code>sap.ui.vbm.Boxes</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.Boxes</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'click' event of this <code>sap.ui.vbm.Boxes</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'contextMenu' event of this <code>sap.ui.vbm.Boxes</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'drop' event of this <code>sap.ui.vbm.Boxes</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
 ...
 * <li>Aggregations
 * <ul>
 * <li>{@link #getItems items} : sap.ui.vbm.Circle[]</li>
 * </ul>
 * </li>
 * <li>Events
 * <ul>
 ...
 * 
 */
sap.ui.vbm.Circles.prototype.click = function(oControlEvent) {  };
 ...
 * 
 */
sap.ui.vbm.Circles.prototype.contextMenu = function(oControlEvent) {  };
 ...
 * 
 */
sap.ui.vbm.Circles.prototype.drop = function(oControlEvent) {  };
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'click' event of this <code>sap.ui.vbm.Circles</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.Circles</code> itself.
 * 
 * The event is raised when there is a click action on a Circle
 * @param {object}
 *            [oData] An application-specific payload object that will be passed to the event handler along with the event object when firing the event.
 ...
 *            fnFunction The function to be called when the event occurs.
 * @param {object}
 *            [oListener] Context object to call the event handler with. Defaults to this <code>sap.ui.vbm.Circles</code> itself.
 * @returns {sap.ui.vbm.Circles} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'contextMenu' event of this <code>sap.ui.vbm.Circles</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.Circles</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'drop' event of this <code>sap.ui.vbm.Circles</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.Circles</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'click' event of this <code>sap.ui.vbm.Circles</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'contextMenu' event of this <code>sap.ui.vbm.Circles</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'drop' event of this <code>sap.ui.vbm.Circles</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
 ...
 * <li>Aggregations
 * <ul>
 * <li>{@link #getVizTemplate vizTemplate} : sap.ui.core.Control</li>
...
/**
 * Destroys the vizTemplate in the aggregation
 * named <code>vizTemplate</code>.
...
/**
 * Destroys the vizVO in the aggregation
 * named <code>vizVO</code>.
 * @returns {sap.ui.vbm.ClusterBase} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
 ...
 * @param {string} [sId] id for the new control, generated automatically if no id is given
 * @param {object} [mSettings] initial settings for the new control
 * @class Cluster definition element for tree clusters. Complex clustering based on Voronoiy diagrams. The actual clustering is based on the areas
 *        in the Voronoiy diagram and cluster objects get aggregated to a hierarchy over several levels of detail.
 * @extends sap.ui.vbm.ClusterBase
 * @experimental Since 1.32.0 this element is experimental and might be modified or removed in future versions.
 * @constructor
 * @public
 ...
 * <li>Aggregations
 * <ul>
 * <li>{@link #getItems items} : sap.ui.vbm.Container[]</li>
 * </ul>
 * </li>
 * <li>Events
 * <ul>
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'click' event of this <code>sap.ui.vbm.Containers</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'contextMenu' event of this <code>sap.ui.vbm.Containers</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.Containers</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'click' event of this <code>sap.ui.vbm.Containers</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'contextMenu' event of this <code>sap.ui.vbm.Containers</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'click' event of this <code>sap.ui.vbm.Feature</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'contextMenu' event of this <code>sap.ui.vbm.Feature</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.Feature</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'click' event of this <code>sap.ui.vbm.Feature</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'contextMenu' event of this <code>sap.ui.vbm.Feature</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
 ...
 * Expects the following event parameters:
 * <ul>
 * <li>'menu' of type <code>sap.ui.unified.Menu</code>Menu object to be used with openContextMenu().</li>
 * </ul>
 * @param {Map} [mArguments] The arguments to pass along with the event.
 * @returns {sap.ui.vbm.Feature} Reference to <code>this</code> in order to allow method chaining
 * @protected
 ...
 * <li>Aggregations
 * <ul>
 * <li>{@link #getItems items} : sap.ui.vbm.Feature[]</li>
 * </ul>
 * </li>
 * <li>Events
 * <ul>
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'click' event of this <code>sap.ui.vbm.FeatureCollection</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'contextMenu' event of this <code>sap.ui.vbm.FeatureCollection</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.FeatureCollection</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'click' event of this <code>sap.ui.vbm.FeatureCollection</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'contextMenu' event of this <code>sap.ui.vbm.FeatureCollection</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
 ...
 * Expects the following event parameters:
 * <ul>
 * <li>'featureId' of type <code>string</code>Id of clicked Feature</li>
 * </ul>
 * @param {Map} [mArguments] The arguments to pass along with the event.
 * @returns {sap.ui.vbm.FeatureCollection} Reference to <code>this</code> in order to allow method chaining
 * @protected
 ...
 * 
 */
sap.ui.vbm.FeatureCollection.prototype.getDefaultBorderColor = function() { return new sap.ui.core.CSSColor(); };
 ...
 * 
 */
sap.ui.vbm.FeatureCollection.prototype.getDefaultFillColor = function() { return new sap.ui.core.CSSColor(); };
 ...
 * 
 */
sap.ui.vbm.FeatureCollection.prototype.getSrcURL = function() { return ""; };

/**
 * Checks for the provided <code>sap.ui.vbm.Feature</code> in the aggregation named <code>items</code>.
 * and returns its index if found or -1 otherwise.
 * @param {sap.ui.vbm.Feature}
 *           oItem The item whose index is looked for.
 * @returns {int} The index of the provided control in the aggregation if found, or -1 otherwise
 ...
 * 
 */
sap.ui.vbm.FeatureCollection.prototype.setDefaultBorderColor = function(sDefaultBorderColor) { return new sap.ui.vbm.FeatureCollection(); };
 ...
 * 
 */
sap.ui.vbm.FeatureCollection.prototype.setDefaultFillColor = function(sDefaultFillColor) { return new sap.ui.vbm.FeatureCollection(); };
 ...
 * 
 */
sap.ui.vbm.FeatureCollection.prototype.setSrcURL = function(sSrcURL) { return new sap.ui.vbm.FeatureCollection(); };
 ...
 * <li>Aggregations
 * <ul>
 * <li>{@link #getItems items} : sap.ui.vbm.GeoCircle[]</li>
 * </ul>
 * </li>
 * <li>Events
 * <ul>
 ...
 * 
 */
sap.ui.vbm.GeoCircles.prototype.click = function(oControlEvent) {  };
 ...
 * 
 */
sap.ui.vbm.GeoCircles.prototype.contextMenu = function(oControlEvent) {  };
 ...
 * 
 */
sap.ui.vbm.GeoCircles.prototype.drop = function(oControlEvent) {  };
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'click' event of this <code>sap.ui.vbm.GeoCircles</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.GeoCircles</code> itself.
 * 
 * The event is raised when there is a click action on a GeoCircle.
 * @param {object}
 *            [oData] An application-specific payload object that will be passed to the event handler along with the event object when firing the event.
 ...
 *            fnFunction The function to be called when the event occurs.
 * @param {object}
 *            [oListener] Context object to call the event handler with. Defaults to this <code>sap.ui.vbm.GeoCircles</code> itself.
 * @returns {sap.ui.vbm.GeoCircles} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'contextMenu' event of this <code>sap.ui.vbm.GeoCircles</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.GeoCircles</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'drop' event of this <code>sap.ui.vbm.GeoCircles</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.GeoCircles</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'click' event of this <code>sap.ui.vbm.GeoCircles</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'contextMenu' event of this <code>sap.ui.vbm.GeoCircles</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'drop' event of this <code>sap.ui.vbm.GeoCircles</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
 ...
 * <li>Aggregations
 * <ul>
 * <li>{@link #getVos vos} : sap.ui.vbm.VoAggregation[]</li>
...
/**
 * Adds some cluster into the aggregation named <code>clusters</code>.
...
/**
 * Adds some featureCollection into the aggregation named <code>featureCollections</code>.
...
/**
 * Adds some resource into the aggregation named <code>resources</code>.
...
/**
 * Adds some vo into the aggregation named <code>vos</code>.
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'centerChanged' event of this <code>sap.ui.vbm.GeoMap</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'click' event of this <code>sap.ui.vbm.GeoMap</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.GeoMap</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'contextMenu' event of this <code>sap.ui.vbm.GeoMap</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.GeoMap</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'drop' event of this <code>sap.ui.vbm.GeoMap</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.GeoMap</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'select' event of this <code>sap.ui.vbm.GeoMap</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.GeoMap</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'zoomChanged' event of this <code>sap.ui.vbm.GeoMap</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.GeoMap</code> itself.
 * 
...
/**
 * Destroys all the clusters in the aggregation
 * named <code>clusters</code>.
 * @returns {sap.ui.vbm.GeoMap} Reference to <code>this</code> in order to allow method chaining
 * @experimental Since 1.32.0 this method is experimental and might be modified or removed in future versions.
 * @public
 * 
...
/**
 * Destroys all the featureCollections in the aggregation
 * named <code>featureCollections</code>.
 * @returns {sap.ui.vbm.GeoMap} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'centerChanged' event of this <code>sap.ui.vbm.GeoMap</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'click' event of this <code>sap.ui.vbm.GeoMap</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'contextMenu' event of this <code>sap.ui.vbm.GeoMap</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'drop' event of this <code>sap.ui.vbm.GeoMap</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'select' event of this <code>sap.ui.vbm.GeoMap</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'zoomChanged' event of this <code>sap.ui.vbm.GeoMap</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
 ...
 * Expects the following event parameters:
 * <ul>
 * <li>'centerPoint' of type <code>string</code>Center point of the map. Format : Lon;Lat;0.0.</li>
 * <li>'viewportBB' of type <code>object</code>Viewport bounding box's upperLeft and lowerRight coordinates. Format : Lon;Lat;0.0.</li>
 * <li>'zoomLevel' of type <code>int</code>Level of detail.</li>
 * </ul>
 * @param {Map} [mArguments] The arguments to pass along with the event.
 * @returns {sap.ui.vbm.GeoMap} Reference to <code>this</code> in order to allow method chaining
 * @protected
 ...
 * Expects the following event parameters:
 * <ul>
 * <li>'pos' of type <code>string</code>Geo coordinates in format "&lt;longitude&gt;;&lt;latitude&gt;;0"</li>
 * </ul>
 * @param {Map} [mArguments] The arguments to pass along with the event.
 * @returns {sap.ui.vbm.GeoMap} Reference to <code>this</code> in order to allow method chaining
 * @protected
 ...
 * @deprecated This property should not longer be used. Its functionality is going to be replaced by the <code>clusters</code>
 *             aggregation.
 * @public
 * 
 */
 ...
 * 
 * Aggregation of GeoJSON Feature collections.
 ...
 * @returns {sap.ui.vbm.VoAggregation[]}
 * @public
 * 
 */
...
/**
 * Checks for the provided <code>sap.ui.vbm.ClusterBase</code> in the aggregation named <code>clusters</code>.
 * and returns its index if found or -1 otherwise.
 * @param {sap.ui.vbm.ClusterBase}
...
/**
 * Checks for the provided <code>sap.ui.vbm.FeatureCollection</code> in the aggregation named <code>featureCollections</code>.
 * and returns its index if found or -1 otherwise.
 * @param {sap.ui.vbm.FeatureCollection}
...
/**
 * Inserts a cluster into the aggregation named <code>clusters</code>.
 * @param {sap.ui.vbm.ClusterBase}
...
/**
 * Inserts a featureCollection into the aggregation named <code>featureCollections</code>.
 * @param {sap.ui.vbm.FeatureCollection}
...
/**
 * Removes all the controls in the aggregation named <code>clusters</code>.
 * 
 * Additionally, it unregisters them from the hosting UIArea.
...
/**
 * Removes all the controls in the aggregation named <code>featureCollections</code>.
 * 
 * Additionally, it unregisters them from the hosting UIArea.
...
/**
 * Removes all the controls in the aggregation named <code>resources</code>.
 * 
 * Additionally, it unregisters them from the hosting UIArea.
...
/**
 * Removes all the controls in the aggregation named <code>vos</code>.
 * 
 * Additionally, it unregisters them from the hosting UIArea.
 * @returns {sap.ui.vbm.VoAggregation[]} An array of the removed elements (might be empty)
 * @public
 * 
 */
...
/**
 * Removes a cluster from the aggregation named <code>clusters</code>.
...
/**
 * Removes a featureCollection from the aggregation named <code>featureCollections</code>.
...
/**
 * Removes a resource from the aggregation named <code>resources</code>.
...
/**
 * Removes a vo from the aggregation named <code>vos</code>.
 * @param {int | string | sap.ui.vbm.VoAggregation} vVo The voto remove or its index or id
 * @returns {sap.ui.vbm.VoAggregation} The removed vo or <code>null</code>
 * @public
 * 
 */
 ...
 * @param {array} oClustering.Cluster Array of Cluster Object
 * @returns {sap.ui.vbm.GeoMap} This allows method chaining
 * @public
 * @deprecated This property should not longer be used. Its functionality is going to be replaced by the <code>clusters</code> aggregation.
 * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
 * 
 */
 ...
 * <li>Aggregations
 * <ul>
 * <li>{@link #getItems items} : sap.ui.vbm.LegendItem[]</li>
 * </ul>
 * </li>
 * <li>Events
 * <ul>
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'click' event of this <code>sap.ui.vbm.Legend</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'click' event of this <code>sap.ui.vbm.Legend</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
 ...
 * Expects the following event parameters:
 * <ul>
 * <li>'data' of type <code>object</code>Event data object</li>
 * </ul>
 * @param {Map} [mArguments] The arguments to pass along with the event.
 * @returns {sap.ui.vbm.Legend} Reference to <code>this</code> in order to allow method chaining
 * @protected
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'click' event of this <code>sap.ui.vbm.LegendItem</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'click' event of this <code>sap.ui.vbm.LegendItem</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
 ...
 * <li>Aggregations
 * <ul>
 * <li>{@link #getItems items} : sap.ui.vbm.PieItem[]</li>
 * </ul>
 * </li>
 * </ul>
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'click' event of this <code>sap.ui.vbm.PieItem</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'click' event of this <code>sap.ui.vbm.PieItem</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
 ...
 * <li>Aggregations
 * <ul>
 * <li>{@link #getItems items} : sap.ui.vbm.Pie[]</li>
 * </ul>
 * </li>
 * <li>Events
 * <ul>
 ...
 * 
 */
sap.ui.vbm.Pies.prototype.click = function(oControlEvent) {  };
 ...
 * 
 */
sap.ui.vbm.Pies.prototype.contextMenu = function(oControlEvent) {  };
 ...
 * 
 */
sap.ui.vbm.Pies.prototype.drop = function(oControlEvent) {  };
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'click' event of this <code>sap.ui.vbm.Pies</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.Pies</code> itself.
 * 
 * The event is raised when there is a click action on a Pie.
 * @param {object}
 *            [oData] An application-specific payload object that will be passed to the event handler along with the event object when firing the event.
 ...
 *            fnFunction The function to be called when the event occurs.
 * @param {object}
 *            [oListener] Context object to call the event handler with. Defaults to this <code>sap.ui.vbm.Pies</code> itself.
 * @returns {sap.ui.vbm.Pies} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'contextMenu' event of this <code>sap.ui.vbm.Pies</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.Pies</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'drop' event of this <code>sap.ui.vbm.Pies</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.Pies</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'click' event of this <code>sap.ui.vbm.Pies</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'contextMenu' event of this <code>sap.ui.vbm.Pies</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'drop' event of this <code>sap.ui.vbm.Pies</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'click' event of this <code>sap.ui.vbm.Region</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'contextMenu' event of this <code>sap.ui.vbm.Region</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.Region</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'click' event of this <code>sap.ui.vbm.Region</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'contextMenu' event of this <code>sap.ui.vbm.Region</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Adds some dragSource into the aggregation named <code>dragSource</code>.
...
/**
 * Adds some dropTarget into the aggregation named <code>dropTarget</code>.
...
/**
 * Removes all the controls in the aggregation named <code>dragSource</code>.
 * 
 * Additionally, it unregisters them from the hosting UIArea.
...
/**
 * Removes all the controls in the aggregation named <code>dropTarget</code>.
 * 
 * Additionally, it unregisters them from the hosting UIArea.
...
/**
 * Removes a dragSource from the aggregation named <code>dragSource</code>.
...
/**
 * Removes a dropTarget from the aggregation named <code>dropTarget</code>.
 ...
 * <li>Aggregations
 * <ul>
 * <li>{@link #getItems items} : sap.ui.vbm.Route[]</li>
 * <li>{@link #getDragSource dragSource} : sap.ui.vbm.DragSource[]</li>
 * <li>{@link #getDropTarget dropTarget} : sap.ui.vbm.DropTarget[]</li>
 * </ul>
 * </li>
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'click' event of this <code>sap.ui.vbm.Routes</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'contextMenu' event of this <code>sap.ui.vbm.Routes</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.Routes</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'drop' event of this <code>sap.ui.vbm.Routes</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.Routes</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'click' event of this <code>sap.ui.vbm.Routes</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'contextMenu' event of this <code>sap.ui.vbm.Routes</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'drop' event of this <code>sap.ui.vbm.Routes</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
 ...
 * <li>Aggregations
 * <ul>
 * <li>{@link #getItems items} : sap.ui.vbm.Spot[]</li>
 * <li>{@link #getDragSource dragSource} : sap.ui.vbm.DragSource[]</li>
 * <li>{@link #getDropTarget dropTarget} : sap.ui.vbm.DropTarget[]</li>
 * </ul>
 * </li>
 ...
 * 
 */
sap.ui.vbm.Spots.prototype.click = function(oControlEvent) {  };
 ...
 * 
 */
sap.ui.vbm.Spots.prototype.contextMenu = function(oControlEvent) {  };
 ...
 * 
 */
sap.ui.vbm.Spots.prototype.drop = function(oControlEvent) {  };
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'click' event of this <code>sap.ui.vbm.Spots</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.Spots</code> itself.
 * 
 * The event is raised when there is a click action on a Spot.
 * @param {object}
 *            [oData] An application-specific payload object that will be passed to the event handler along with the event object when firing the event.
 ...
 *            fnFunction The function to be called when the event occurs.
 * @param {object}
 *            [oListener] Context object to call the event handler with. Defaults to this <code>sap.ui.vbm.Spots</code> itself.
 * @returns {sap.ui.vbm.Spots} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'contextMenu' event of this <code>sap.ui.vbm.Spots</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.Spots</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'drop' event of this <code>sap.ui.vbm.Spots</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.Spots</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'click' event of this <code>sap.ui.vbm.Spots</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'contextMenu' event of this <code>sap.ui.vbm.Spots</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'drop' event of this <code>sap.ui.vbm.Spots</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'closeWindow' event of this <code>sap.ui.vbm.VBI</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'move' event of this <code>sap.ui.vbm.VBI</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.VBI</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'openWindow' event of this <code>sap.ui.vbm.VBI</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.VBI</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'render' event of this <code>sap.ui.vbm.VBI</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.VBI</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'submit' event of this <code>sap.ui.vbm.VBI</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.VBI</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'thumbnailClick' event of this <code>sap.ui.vbm.VBI</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.VBI</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'zoom' event of this <code>sap.ui.vbm.VBI</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.VBI</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'closeWindow' event of this <code>sap.ui.vbm.VBI</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'move' event of this <code>sap.ui.vbm.VBI</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'openWindow' event of this <code>sap.ui.vbm.VBI</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'render' event of this <code>sap.ui.vbm.VBI</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'submit' event of this <code>sap.ui.vbm.VBI</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'thumbnailClick' event of this <code>sap.ui.vbm.VBI</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'zoom' event of this <code>sap.ui.vbm.VBI</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
 ...
 * Expects the following event parameters:
 * <ul>
 * <li>'data' of type <code>string</code>JSON (or possibly XML and case the plugin is used) string describing the delta state of Visual Business and the information
 * about the event.</li>
 * </ul>
 * @param {Map} [mArguments] The arguments to pass along with the event.
 * @returns {sap.ui.vbm.VBI} Reference to <code>this</code> in order to allow method chaining
 ...
 * Expects the following event parameters:
 * <ul>
 * <li>'pos' of type <code>string</code>Geo coordinates in format "lon;lat;0"</li>
 * <li>'zoomLevel' of type <code>int</code>Level of detail.</li>
 * </ul>
 * @param {Map} [mArguments] The arguments to pass along with the event.
 * @returns {sap.ui.vbm.VBI} Reference to <code>this</code> in order to allow method chaining
 ...
 * 
 */
sap.ui.vbm.VBI.prototype.minimize = function(iNewWidth,iNewHeight,iFullWidth,iFullHeight) { return null; };
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'deselect' event of this <code>sap.ui.vbm.VoAggregation</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'handleClick' event of this <code>sap.ui.vbm.VoAggregation</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.VoAggregation</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'handleContextMenu' event of this <code>sap.ui.vbm.VoAggregation</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.VoAggregation</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'handleMoved' event of this <code>sap.ui.vbm.VoAggregation</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.VoAggregation</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'select' event of this <code>sap.ui.vbm.VoAggregation</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.VoAggregation</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'deselect' event of this <code>sap.ui.vbm.VoAggregation</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'handleClick' event of this <code>sap.ui.vbm.VoAggregation</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'handleContextMenu' event of this <code>sap.ui.vbm.VoAggregation</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'handleMoved' event of this <code>sap.ui.vbm.VoAggregation</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'select' event of this <code>sap.ui.vbm.VoAggregation</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
 ...
 * 
 */
sap.ui.vbm.VoAggregation.prototype.openContextMenu = function(sType,oVoInst,oMenu) { return null; };
 ...
 *        <ul>
 *        <li>A controlled mode by providing a label type. In this mode most parameters for the label are automatically set by programmed defaults
 *        according to the Fiori guidelines.</li>
 *        <li>A freestyle mode, providing the full control on colors and layout.</li>
 *        </ul>
 ...
 * @param {sap.ui.base.EventProvider} oControlEvent.getSource
 * @param {object} oControlEvent.getParameters
 * @param {string} oControlEvent.getParameters.changedPos Changed position after handle moved
 * @public
 * 
 */
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'click' event of this <code>sap.ui.vbm.VoBase</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'contextMenu' event of this <code>sap.ui.vbm.VoBase</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.VoBase</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'drop' event of this <code>sap.ui.vbm.VoBase</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.VoBase</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'handleClick' event of this <code>sap.ui.vbm.VoBase</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.VoBase</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'handleContextMenu' event of this <code>sap.ui.vbm.VoBase</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.VoBase</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'handleMoved' event of this <code>sap.ui.vbm.VoBase</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.vbm.VoBase</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'click' event of this <code>sap.ui.vbm.VoBase</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'contextMenu' event of this <code>sap.ui.vbm.VoBase</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'drop' event of this <code>sap.ui.vbm.VoBase</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'handleClick' event of this <code>sap.ui.vbm.VoBase</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'handleContextMenu' event of this <code>sap.ui.vbm.VoBase</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'handleMoved' event of this <code>sap.ui.vbm.VoBase</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
 ...
 * Expects the following event parameters:
 * <ul>
 * <li>'menu' of type <code>sap.ui.unified.Menu</code>Menu to open</li>
 * </ul>
 * @param {Map} [mArguments] The arguments to pass along with the event.
 * @returns {sap.ui.vbm.VoBase} Reference to <code>this</code> in order to allow method chaining
 * @protected
 ...
 * Expects the following event parameters:
 * <ul>
 * <li>'changedPos' of type <code>string</code>Changed position after handle moved</li>
 * </ul>
 * @param {Map} [mArguments] The arguments to pass along with the event.
 * @returns {sap.ui.vbm.VoBase} Reference to <code>this</code> in order to allow method chaining
 * @protected
