 ...
 * @class
 * The control displays filters in a user-friendly manner to populate values for a query. The FilterBar consists of a row containing the {@link sap.ui.comp.variants.VariantManagement VariantManagement} control, the related buttons, 
 * and an area underneath displaying the filters.
 * The filters are arranged in a logical row that is divided depending on the space available and the width of the filters.
 * The area containing the filters can be hidden or shown using the Hide Filter Bar / Show Filter Bar button. The Go button triggers the search event, and the Filters button shows the filter dialog.<br> 
 * In this dialog, the consumer has full control over the filter bar.
 * The filters in this dialog are displayed in one column and organized in groups. The filter items of the <code>filterItems</code> aggregation are grouped in the Basic group . 
 * Each filter can be marked as visible in the filter bar by selecting Add to Filter Bar. In addition, the items in the <code>filterGroupItems</code> aggregation can be marked as part of the current variant.
 * The FilterBar also supports a different UI layout when used inside a value help dialog. In this case the FilterBar consists of two logical areas, one containing the general search button and in the Advanced Search area.
...
/**
 * Applies the variant.
 * This method is executed from the {@link sap.ui.comp.smartvariants.SmartVariantManagement SmartVariantManagement} control. 
 * @param {object} oVariant JSON object
 * @param {string} sContext Describes in which context the variant is applied. The context is passed on to the application via the afterVariantLoad event   
 * @public
 * 
 */
sap.ui.comp.filterbar.FilterBar.prototype.applyVariant = function(oVariant,sContext) {  };

/**
 * Attaches event handler <code>fnFunction</code> to the 'afterVariantLoad' event of this <code>sap.ui.comp.filterbar.FilterBar</code>.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'afterVariantSave' event of this <code>sap.ui.comp.filterbar.FilterBar</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.filterbar.FilterBar</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'beforeVariantFetch' event of this <code>sap.ui.comp.filterbar.FilterBar</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.filterbar.FilterBar</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'beforeVariantSave' event of this <code>sap.ui.comp.filterbar.FilterBar</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.filterbar.FilterBar</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'cancel' event of this <code>sap.ui.comp.filterbar.FilterBar</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.filterbar.FilterBar</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'clear' event of this <code>sap.ui.comp.filterbar.FilterBar</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.filterbar.FilterBar</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'filterChange' event of this <code>sap.ui.comp.filterbar.FilterBar</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.filterbar.FilterBar</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'initialise' event of this <code>sap.ui.comp.filterbar.FilterBar</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.filterbar.FilterBar</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'reset' event of this <code>sap.ui.comp.filterbar.FilterBar</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.filterbar.FilterBar</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'search' event of this <code>sap.ui.comp.filterbar.FilterBar</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.filterbar.FilterBar</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'afterVariantLoad' event of this <code>sap.ui.comp.filterbar.FilterBar</code>.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'afterVariantSave' event of this <code>sap.ui.comp.filterbar.FilterBar</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'beforeVariantFetch' event of this <code>sap.ui.comp.filterbar.FilterBar</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'beforeVariantSave' event of this <code>sap.ui.comp.filterbar.FilterBar</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'cancel' event of this <code>sap.ui.comp.filterbar.FilterBar</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'clear' event of this <code>sap.ui.comp.filterbar.FilterBar</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'filterChange' event of this <code>sap.ui.comp.filterbar.FilterBar</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'initialise' event of this <code>sap.ui.comp.filterbar.FilterBar</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'reset' event of this <code>sap.ui.comp.filterbar.FilterBar</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'search' event of this <code>sap.ui.comp.filterbar.FilterBar</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
 ...
 * This method is executed from the SmartVariantManagement control.
 ...
 * <ul>
 * <li>'selectionSet' of type <code>sap.ui.core.Control[]</code>Visible controls</li>
 * </ul>
 * @param {Map} [mArguments] The arguments to pass along with the event.
 * @returns {sap.ui.comp.filterbar.FilterBar} Reference to <code>this</code> in order to allow method chaining
 * @protected
...
/**
 * ID of the element which is the current target of the <code>basicSearch</code> association, or <code>null</code>.
 * 
 ...
 * @public
 * @since 1.28.0
 * @param {boolean} bConsiderAllFilters If set to <code>false</code> only visible filters are retrieved
...
/**
 * Removes a filterGroupItem from the aggregation named <code>filterGroupItems</code>.
...
/**
 * Removes a filterItem from the aggregation named <code>filterItems</code>.
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'change' event of this <code>sap.ui.comp.filterbar.FilterItem</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'change' event of this <code>sap.ui.comp.filterbar.FilterItem</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
 ...
 * @param {object} [mSettings] Initial settings for the new control
 * @class
 * The NavigationPopover allows navigating to different destinations by providing links on a popover.<br>
 * The links are fetched using the {@link sap.ushell.services.CrossApplicationNavigation CrossApplicationNavigation} service of the unified shell.<br>
 * 
 * This class gets instantiated by {@link sap.ui.comp.navpopover.SmartLink SmartLink}. It is recommended to use {@link sap.ui.comp.navpopover.SmartLink SmartLink} instead of creating NavigationPopover manually.
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'navigate' event of this <code>sap.ui.comp.navpopover.NavigationPopover</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'targetsObtained' event of this <code>sap.ui.comp.navpopover.NavigationPopover</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.navpopover.NavigationPopover</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'navigate' event of this <code>sap.ui.comp.navpopover.NavigationPopover</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'targetsObtained' event of this <code>sap.ui.comp.navpopover.NavigationPopover</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * ID of the element which is the current target of the <code>component</code> association, or <code>null</code>.
 * 
...
/**
 * ID of the element which is the current target of the <code>extraContent</code> association, or <code>null</code>.
 * 
...
/**
 * ID of the element which is the current target of the <code>source</code> association, or <code>null</code>.
 * 
...
/**
 * Removes all the controls in the aggregation named <code>availableActions</code>.
 * 
...
/**
 * Removes a availableAction from the aggregation named <code>availableActions</code>.
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'beforePopoverOpens' event of this <code>sap.ui.comp.navpopover.SemanticObjectController</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'navigate' event of this <code>sap.ui.comp.navpopover.SemanticObjectController</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.navpopover.SemanticObjectController</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'navigationTargetsObtained' event of this <code>sap.ui.comp.navpopover.SemanticObjectController</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.navpopover.SemanticObjectController</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'prefetchDone' event of this <code>sap.ui.comp.navpopover.SemanticObjectController</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.navpopover.SemanticObjectController</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'beforePopoverOpens' event of this <code>sap.ui.comp.navpopover.SemanticObjectController</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'navigate' event of this <code>sap.ui.comp.navpopover.SemanticObjectController</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'navigationTargetsObtained' event of this <code>sap.ui.comp.navpopover.SemanticObjectController</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'prefetchDone' event of this <code>sap.ui.comp.navpopover.SemanticObjectController</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'beforePopoverOpens' event of this <code>sap.ui.comp.navpopover.SmartLink</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'innerNavigate' event of this <code>sap.ui.comp.navpopover.SmartLink</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.navpopover.SmartLink</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'navigationTargetsObtained' event of this <code>sap.ui.comp.navpopover.SmartLink</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.navpopover.SmartLink</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'beforePopoverOpens' event of this <code>sap.ui.comp.navpopover.SmartLink</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'innerNavigate' event of this <code>sap.ui.comp.navpopover.SmartLink</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'navigationTargetsObtained' event of this <code>sap.ui.comp.navpopover.SmartLink</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'fieldSelectionChanged' event of this <code>sap.ui.comp.odata.FieldSelector</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'fieldSelectionChanged' event of this <code>sap.ui.comp.odata.FieldSelector</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'change' event of this <code>sap.ui.comp.smartfield.SmartField</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'contextEditableChanged' event of this <code>sap.ui.comp.smartfield.SmartField</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.smartfield.SmartField</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'editableChanged' event of this <code>sap.ui.comp.smartfield.SmartField</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.smartfield.SmartField</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'entitySetFound' event of this <code>sap.ui.comp.smartfield.SmartField</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.smartfield.SmartField</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'initialise' event of this <code>sap.ui.comp.smartfield.SmartField</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.smartfield.SmartField</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'innerControlsCreated' event of this <code>sap.ui.comp.smartfield.SmartField</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.smartfield.SmartField</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'valueListChanged' event of this <code>sap.ui.comp.smartfield.SmartField</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.smartfield.SmartField</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'visibleChanged' event of this <code>sap.ui.comp.smartfield.SmartField</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.smartfield.SmartField</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'change' event of this <code>sap.ui.comp.smartfield.SmartField</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'contextEditableChanged' event of this <code>sap.ui.comp.smartfield.SmartField</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'editableChanged' event of this <code>sap.ui.comp.smartfield.SmartField</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'entitySetFound' event of this <code>sap.ui.comp.smartfield.SmartField</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'initialise' event of this <code>sap.ui.comp.smartfield.SmartField</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'innerControlsCreated' event of this <code>sap.ui.comp.smartfield.SmartField</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'valueListChanged' event of this <code>sap.ui.comp.smartfield.SmartField</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'visibleChanged' event of this <code>sap.ui.comp.smartfield.SmartField</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'change' event of this <code>sap.ui.comp.smartfilterbar.ControlConfiguration</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'change' event of this <code>sap.ui.comp.smartfilterbar.ControlConfiguration</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Removes all the controls in the aggregation named <code>defaultFilterValues</code>.
 * 
 * Additionally, it unregisters them from the hosting UIArea.
...
/**
 * Removes a defaultFilterValue from the aggregation named <code>defaultFilterValues</code>.
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'change' event of this <code>sap.ui.comp.smartfilterbar.GroupConfiguration</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'change' event of this <code>sap.ui.comp.smartfilterbar.GroupConfiguration</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Removes all the controls in the aggregation named <code>controlConfiguration</code>.
 * 
 * Additionally, it unregisters them from the hosting UIArea.
...
/**
 * Removes all the controls in the aggregation named <code>groupConfiguration</code>.
 * 
 * Additionally, it unregisters them from the hosting UIArea.
...
/**
 * Removes a controlConfiguration from the aggregation named <code>controlConfiguration</code>.
...
/**
 * Removes a groupConfiguration from the aggregation named <code>groupConfiguration</code>.
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'labelChanged' event of this <code>sap.ui.comp.smartform.flexibility.FieldList</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'nodeHidden' event of this <code>sap.ui.comp.smartform.flexibility.FieldList</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.smartform.flexibility.FieldList</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'selectionChanged' event of this <code>sap.ui.comp.smartform.flexibility.FieldList</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.smartform.flexibility.FieldList</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'labelChanged' event of this <code>sap.ui.comp.smartform.flexibility.FieldList</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'nodeHidden' event of this <code>sap.ui.comp.smartform.flexibility.FieldList</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'selectionChanged' event of this <code>sap.ui.comp.smartform.flexibility.FieldList</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Fires event labelChanged to attached listeners.
 * @param {Map} [mArguments] The arguments to pass along with the event.
 * @returns {sap.ui.comp.smartform.flexibility.FieldList} Reference to <code>this</code> in order to allow method chaining
 * @protected
 * 
...
/**
 * Fires event nodeHidden to attached listeners.
 * @param {Map} [mArguments] The arguments to pass along with the event.
 * @returns {sap.ui.comp.smartform.flexibility.FieldList} Reference to <code>this</code> in order to allow method chaining
 * @protected
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'labelChanged' event of this <code>sap.ui.comp.smartform.flexibility.FieldListNode</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'nodeHidden' event of this <code>sap.ui.comp.smartform.flexibility.FieldListNode</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.smartform.flexibility.FieldListNode</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'selected' event of this <code>sap.ui.comp.smartform.flexibility.FieldListNode</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.smartform.flexibility.FieldListNode</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'labelChanged' event of this <code>sap.ui.comp.smartform.flexibility.FieldListNode</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'nodeHidden' event of this <code>sap.ui.comp.smartform.flexibility.FieldListNode</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'selected' event of this <code>sap.ui.comp.smartform.flexibility.FieldListNode</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
 ...
 * Expects the following event parameters:
 * <ul>
 * <li>'target' of type <code>sap.ui.comp.smartform.flexibility.FieldListNode</code>The inner node which was hidden</li>
 * </ul>
 * @param {Map} [mArguments] The arguments to pass along with the event.
 * @returns {sap.ui.comp.smartform.flexibility.FieldListNode} Reference to <code>this</code> in order to allow method chaining
 * @protected
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'selectedByKeyboard' event of this <code>sap.ui.comp.smartform.flexibility.Input</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'selectedByKeyboard' event of this <code>sap.ui.comp.smartform.flexibility.Input</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'visibleChanged' event of this <code>sap.ui.comp.smartform.GroupElement</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'visibleChanged' event of this <code>sap.ui.comp.smartform.GroupElement</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Checks for the provided <code>sap.ui.core.Control</code> in the aggregation named <code>elements</code>.
 * and returns its index if found or -1 otherwise.
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'checked' event of this <code>sap.ui.comp.smartform.SmartForm</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'editToggled' event of this <code>sap.ui.comp.smartform.SmartForm</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.smartform.SmartForm</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'checked' event of this <code>sap.ui.comp.smartform.SmartForm</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'editToggled' event of this <code>sap.ui.comp.smartform.SmartForm</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'afterVariantApply' event of this <code>sap.ui.comp.smarttable.SmartTable</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'afterVariantInitialise' event of this <code>sap.ui.comp.smarttable.SmartTable</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.smarttable.SmartTable</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'afterVariantSave' event of this <code>sap.ui.comp.smarttable.SmartTable</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.smarttable.SmartTable</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'beforeRebindTable' event of this <code>sap.ui.comp.smarttable.SmartTable</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.smarttable.SmartTable</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'dataReceived' event of this <code>sap.ui.comp.smarttable.SmartTable</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.smarttable.SmartTable</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'editToggled' event of this <code>sap.ui.comp.smarttable.SmartTable</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.smarttable.SmartTable</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'initialise' event of this <code>sap.ui.comp.smarttable.SmartTable</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.smarttable.SmartTable</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'showOverlay' event of this <code>sap.ui.comp.smarttable.SmartTable</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.smarttable.SmartTable</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'afterVariantApply' event of this <code>sap.ui.comp.smarttable.SmartTable</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'afterVariantInitialise' event of this <code>sap.ui.comp.smarttable.SmartTable</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'afterVariantSave' event of this <code>sap.ui.comp.smarttable.SmartTable</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'beforeRebindTable' event of this <code>sap.ui.comp.smarttable.SmartTable</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'dataReceived' event of this <code>sap.ui.comp.smarttable.SmartTable</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'editToggled' event of this <code>sap.ui.comp.smarttable.SmartTable</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'initialise' event of this <code>sap.ui.comp.smarttable.SmartTable</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'showOverlay' event of this <code>sap.ui.comp.smarttable.SmartTable</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * ID of the element which is the current target of the <code>control</code> association, or <code>null</code>.
 * 
 ...
 * @param {object} [mSettings] initial settings for the new control
 * @class
 * The SmartVariantManagement control is a specialization of the {@link sap.ui.comp.variants.VariantManagement VariantManagement} control and communicates with the layer that offers SAPUI5 flexibility services to manage the variants.<br>
 * For more information about SAPUI5 flexibility, refer to the Developer Guide.
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'afterSave' event of this <code>sap.ui.comp.smartvariants.SmartVariantManagement</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'initialise' event of this <code>sap.ui.comp.smartvariants.SmartVariantManagement</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.smartvariants.SmartVariantManagement</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'afterSave' event of this <code>sap.ui.comp.smartvariants.SmartVariantManagement</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'initialise' event of this <code>sap.ui.comp.smartvariants.SmartVariantManagement</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Removes all the controls in the aggregation named <code>personalizableControls</code>.
 * 
 * Additionally, it unregisters them from the hosting UIArea.
...
/**
 * Removes a personalizableControl from the aggregation named <code>personalizableControls</code>.
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'afterSave' event of this <code>sap.ui.comp.smartvariants.SmartVariantManagementUi2</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'initialise' event of this <code>sap.ui.comp.smartvariants.SmartVariantManagementUi2</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.smartvariants.SmartVariantManagementUi2</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'afterSave' event of this <code>sap.ui.comp.smartvariants.SmartVariantManagementUi2</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'initialise' event of this <code>sap.ui.comp.smartvariants.SmartVariantManagementUi2</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'cancel' event of this <code>sap.ui.comp.transport.TransportDialog</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'ok' event of this <code>sap.ui.comp.transport.TransportDialog</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.transport.TransportDialog</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'cancel' event of this <code>sap.ui.comp.transport.TransportDialog</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'ok' event of this <code>sap.ui.comp.transport.TransportDialog</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'cancel' event of this <code>sap.ui.comp.valuehelpdialog.ValueHelpDialog</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'ok' event of this <code>sap.ui.comp.valuehelpdialog.ValueHelpDialog</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.valuehelpdialog.ValueHelpDialog</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'selectionChange' event of this <code>sap.ui.comp.valuehelpdialog.ValueHelpDialog</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.valuehelpdialog.ValueHelpDialog</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'tokenRemove' event of this <code>sap.ui.comp.valuehelpdialog.ValueHelpDialog</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.valuehelpdialog.ValueHelpDialog</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'updateSelection' event of this <code>sap.ui.comp.valuehelpdialog.ValueHelpDialog</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.valuehelpdialog.ValueHelpDialog</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'cancel' event of this <code>sap.ui.comp.valuehelpdialog.ValueHelpDialog</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'ok' event of this <code>sap.ui.comp.valuehelpdialog.ValueHelpDialog</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'selectionChange' event of this <code>sap.ui.comp.valuehelpdialog.ValueHelpDialog</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'tokenRemove' event of this <code>sap.ui.comp.valuehelpdialog.ValueHelpDialog</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'updateSelection' event of this <code>sap.ui.comp.valuehelpdialog.ValueHelpDialog</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
 ...
 * Expects the following event parameters:
 * <ul>
 * <li>'tokens' of type <code>sap.m.Token[]</code>The array of tokens created or modified on the ValueHelpDialog.</li>
 * </ul>
 * @param {Map} [mArguments] The arguments to pass along with the event.
 * @returns {sap.ui.comp.valuehelpdialog.ValueHelpDialog} Reference to <code>this</code> in order to allow method chaining
 * @protected
 ...
 * Expects the following event parameters:
 * <ul>
 * <li>'tableSelectionParams' of type <code>object</code>The RowSelectionChange event parameter from the hosted table that contains the selected items.</li>
 * <li>'updateTokens' of type <code>object[]</code>Returns an array of objects which represents all selected row tokens. 
 *  The object contains the token key, the row object data from the model, and the information if the token is selected.
 *  <code>
 *  [{sKey, oRow, bSelect}, ...]
 *  </code></li>
 * <li>'useDefault' of type <code>boolean</code>Can be set to true to execute the default behaviour of the ValueHelpDialog.</li>
 * </ul>
 * @param {Map} [mArguments] The arguments to pass along with the event.
 * @returns {sap.ui.comp.valuehelpdialog.ValueHelpDialog} Reference to <code>this</code> in order to allow method chaining
 * @protected
 ...
 * Expects the following event parameters:
 * <ul>
 * <li>'tokenKeys' of type <code>string[]</code>The array of token keys that has been removed.</li>
 * <li>'useDefault' of type <code>boolean</code>Can be set to true to execute the default behaviour of ValueHelpDialog.</li>
 * </ul>
 * @param {Map} [mArguments] The arguments to pass along with the event.
 * @returns {sap.ui.comp.valuehelpdialog.ValueHelpDialog} Reference to <code>this</code> in order to allow method chaining
 * @protected
 ...
 * Expects the following event parameters:
 * <ul>
 * <li>'tokenKeys' of type <code>string[]</code>The array of existing token keys for which the selection in the table has to be updated.</li>
 * <li>'useDefault' of type <code>boolean</code>Can be set to true to execute the default behavior of ValueHelpDialog.</li>
 * </ul>
 * @param {Map} [mArguments] The arguments to pass along with the event.
 * @returns {sap.ui.comp.valuehelpdialog.ValueHelpDialog} Reference to <code>this</code> in order to allow method chaining
 * @protected
 ...
 * 
 */
sap.ui.comp.valuehelpdialog.ValueHelpDialog.prototype.setExcludeRangeOperations = function(aOperation) {  };
 ...
 * 
 */
sap.ui.comp.valuehelpdialog.ValueHelpDialog.prototype.setIncludeRangeOperations = function(aOperation) {  };
 ...
 * @class The VariantManagement control can be used to manage variants, such as filter bar variants or table
 *        variants.
 * @extends sap.ui.core.Control
 * @constructor
 * @public
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'manage' event of this <code>sap.ui.comp.variants.VariantManagement</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'save' event of this <code>sap.ui.comp.variants.VariantManagement</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.variants.VariantManagement</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'select' event of this <code>sap.ui.comp.variants.VariantManagement</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.comp.variants.VariantManagement</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'manage' event of this <code>sap.ui.comp.variants.VariantManagement</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'save' event of this <code>sap.ui.comp.variants.VariantManagement</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'select' event of this <code>sap.ui.comp.variants.VariantManagement</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
 ...
 * Expects the following event parameters:
 * <ul>
 * <li>'renamed' of type <code>string[]</code>List of changed variant keys</li>
 * <li>'deleted' of type <code>string[]</code>List of deleted variant keys</li>
 * <li>'exe' of type <code>object[]</code>List of variant keys and the associated Execute on Selection indicator</li>
 * <li>'def' of type <code>boolean</code>The default variant key</li>
 * </ul>
 * @param {Map} [mArguments] The arguments to pass along with the event.
 * @returns {sap.ui.comp.variants.VariantManagement} Reference to <code>this</code> in order to allow method chaining
 * @protected
 ...
 * Expects the following event parameters:
 * <ul>
 * <li>'name' of type <code>string</code>The variant title</li>
 * <li>'overwrite' of type <code>boolean</code>Indicates if an existing variant is overwritten or if a new variant is created</li>
 * <li>'key' of type <code>string</code>The variant key</li>
 * <li>'exe' of type <code>boolean</code>The Execute on Selection indicator</li>
 * <li>'def' of type <code>boolean</code>The default variant indicator</li>
 * <li>'global' of type <code>boolean</code>The shared variant indicator</li>
 * <li>'lifecyclePackage' of type <code>string</code>The package name</li>
 * <li>'lifecycleTransportId' of type <code>string</code>The transport ID</li>
 * </ul>
 * @param {Map} [mArguments] The arguments to pass along with the event.
 * @returns {sap.ui.comp.variants.VariantManagement} Reference to <code>this</code> in order to allow method chaining
 * @protected
 ...
 * 
 * Provides a string value to set the default variant. Used for the save dialog. Has no effect on the
 * selected variant.
...
/**
 * Removes all the controls in the aggregation named <code>variantItems</code>.
 * 
 * Additionally, it unregisters them from the hosting UIArea.
...
/**
 * Removes a variantItem from the aggregation named <code>variantItems</code>.
