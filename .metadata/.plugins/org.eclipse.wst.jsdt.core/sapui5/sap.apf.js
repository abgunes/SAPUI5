 ...
 * ription  Adds a path filter fragment for a path context.
 ...
 * @param {sap.apf.utils.Filter} filter
 * ription Updates or creates a path filter fragment for the given identifier by fully replacing the existing one.
 * @returns {string} id for update
 */
sap.apf.Api.prototype.updatePathFilter = function(id,filter) { return ""; };
