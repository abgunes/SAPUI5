 ...
 * 
 */
sap.ushell.services.CrossApplicationNavigation.prototype.createEmptyAppState = function(oAppComponent) { return new Object(); };
 ...
 * 
 */
sap.ushell.services.CrossApplicationNavigation.prototype.getAppState = function(oAppComponent,sAppStateKey) { return new Object(); };
 ...
 * 
 */
sap.ushell.services.CrossApplicationNavigation.prototype.getStartupAppState = function(oAppComponent) { return new Object(); };
 ...
 * 
 */
sap.ushell.services.UsageAnalytics.prototype.init = function() {  };
 ...
 * 
 */
sap.ushell.services.UsageAnalytics.prototype.isEnabled = function() { return false; };
 ...
 * 
 */
sap.ushell.services.UsageAnalytics.prototype.logCustomEvent = function(eventType,customEventValue,aAdditionalValues) {  };
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'expand' event of this <code>sap.ushell.ui.shell.ToolAreaItem</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'press' event of this <code>sap.ushell.ui.shell.ToolAreaItem</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ushell.ui.shell.ToolAreaItem</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'expand' event of this <code>sap.ushell.ui.shell.ToolAreaItem</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'press' event of this <code>sap.ushell.ui.shell.ToolAreaItem</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
