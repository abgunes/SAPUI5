...
/**
 * Attaches event handler <code>fnFunction</code> to the 'beforeEditorInit' event of this <code>sap.ui.richtexteditor.RichTextEditor</code>.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'change' event of this <code>sap.ui.richtexteditor.RichTextEditor</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.richtexteditor.RichTextEditor</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the 'ready' event of this <code>sap.ui.richtexteditor.RichTextEditor</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified
 * otherwise it will be bound to this <code>sap.ui.richtexteditor.RichTextEditor</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'beforeEditorInit' event of this <code>sap.ui.richtexteditor.RichTextEditor</code>.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'change' event of this <code>sap.ui.richtexteditor.RichTextEditor</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
...
/**
 * Detaches event handler <code>fnFunction</code> from the 'ready' event of this <code>sap.ui.richtexteditor.RichTextEditor</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs.
